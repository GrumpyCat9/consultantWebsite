		...
		<div><nav class="navbar navbar-expand-lg navbar-light"
				...
				<div class="container-fluid">
					<div class="collapse navbar-collapse" id="navbarNav"
						...
						<ul class="navbar-nav">
							<li class="nav-item"><a class="nav-link active" href="jobConsultant-home-page.jsp"
		...
		<div
					...
					<form action="appointmentmanager" method="post">
						<input type="hidden" name="actionType"
							value="fetchAppointmentsForConsultants"> <input
							type="hidden" name="jobConsultantId" value="${cookie.userId.value}">
